<template>
  <div class="fixed top-4 left-4 flex justify-between md:max-w-md w-full z-50">
    <input
      v-model.trim="searchText"
      class="md:rounded-xl px-3 py-2 flex-1 bg-gray-100 focus:bg-white placeholder-gray-500 shadow-md duration-100 ease-in-out focus:outline-none border-2 border-transparent focus:border-gray-500"
    ...
    >
    <button
      class="md:rounded-xl px-3 py-2 bg-gray-100 flex-none ml-2 shadow-md focus:outline-none border-2 border-transparent focus:bg-white focus:border-gray-500 transition duration-100 transform active:scale-95"
      type="submit"
      @click="onSearch"
    >
      Search
